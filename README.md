...
scripts for installing both Pterodactyl Panel & Daemon.
...
You can fork this repository and use the `install-panel.sh` and `install-daemon.sh` scripts

### Alternative Methods

The following downloads the script and runs the script. To download without running remove ` | bash` from the end of the command
> Note: The script requires the executing user to have sudo permissions to run

#### Panel Script
##### Curl
```bash
curl -s https://raw.githubusercontent.com/ROMVoid95/PteroInstall/master/panel.sh | bash
```
##### wget 
```bash
wget -O https://raw.githubusercontent.com/ROMVoid95/PteroInstall/master/panel.sh | bash
```

#### Daemon Script
##### Curl
```bash
curl -s https://raw.githubusercontent.com/ROMVoid95/PteroInstall/master/daemon.sh | bash
```
##### wget 
```bash
wget -O https://raw.githubusercontent.com/ROMVoid95/PteroInstall/master/daemon.sh | bash
```
