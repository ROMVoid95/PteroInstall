...
CONFIGS_URL="https://raw.githubusercontent.com/ROMVoid95/PteroInstall/master/configs"
...
function install_daemon {
  ...
  if [[ "$INSTALL_DAEMON" =~ [Yy] ]]; then
    bash <(curl -s https://raw.githubusercontent.com/ROMVoid95/PteroInstall/master/install-daemon.sh)
  fi
}
...
function main {
  ...
  echo "* https://github.com/ROMVoid95/PteroInstall"
  echo "*"
